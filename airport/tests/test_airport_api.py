...
class AuthenticatedAirportApiTests(TestCase):
    ...
    def test_filter_airports_by_closest_big_city(self):
        ...
        res = self.client.get(AIRPORT_URL, {"closest_big_city": "City"})
    ...
    def test_create_airport_forbidden(self):
        ...
        payload = {"name": "Forbidden Airport", "closest_big_city": city.pk}
...
class AdminAirportApiTests(TestCase):
    ...
    def test_create_airport(self):
        ...
        payload = {"name": "Test Airport", "closest_big_city": city.pk}
