...
class AuthenticatedFlightApiTests(TestCase):
    ...
    def test_filter_flights_by_routes(self):
        ...
        res = self.client.get(FLIGHT_URL, {"routes": f"{route1.id}, {route2.id}"})
    ...
    def test_filter_flights_by_crews(self):
        crew1 = Crew.objects.create(first_name="First", last_name="Crew")
        crew2 = Crew.objects.create(first_name="Second", last_name="Crew")
        crew3 = Crew.objects.create(first_name="Third", last_name="Crew")
        ...
        res = self.client.get(FLIGHT_URL, {"crews": f"{crew1.id}, {crew2.id}"})
...
class AdminFlightApiTests(TestCase):
    ...
    def test_create_flight(self):
        route = sample_route()
        airplane = sample_airplane()
        crew1 = Crew.objects.create(first_name="FirstName1", last_name="LastName1")
        crew2 = Crew.objects.create(first_name="FirstName2", last_name="LastName2")
